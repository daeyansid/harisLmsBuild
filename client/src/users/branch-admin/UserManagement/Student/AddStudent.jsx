...
const AddStudent = () => {
    ...
    const handleBatchYearChange = async (e) => {
        ...
        if (batchYear) {
            try {
                const studentsInBatch = await fetchStudentsByBatchYear(batchYear, formData.branchId);
...
const handleGuardianCnicChange = (e) => {
    ...
    const handleStepChange = (newStep) => {
        ...
        if (!validateCnic(guardianCnic)) {
            setErrors({ guardianCnic: 'CNIC must be in the format 00000-0000000-0.' });
            return;
        }
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateStep(step)) {
            ...
            try {
                ...
                console.error('Error creating student:', error.response ? error.response.data : error);
                Swal.fire({
                    icon: 'error',
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <>
                        ...
                        <div className="mb-4">
                            ...
                            >
                                ...
                                {Array.from({ length: new Date().getFullYear() - 2009 }, (_, i) => 2010 + i).map((year) => (
                ...
                {step === 2 && (
                    <>
                        ...
                        {errors.guardianCnic && <p className="text-red-600 mt-2">{errors.guardianCnic}</p>}
                    </div>

                        {guardianDetails && (
                            <div className="bg-gray-100 p-4 rounded-md shadow-md">
                                <h3 className="text-lg font-semibold text-indigo-800 mb-4">Guardian Information</h3>
                                <div className="mb-4">
                                    <label className="block text-gray-700 font-semibold">Full Name</label>
                        ...
                        <div className="flex justify-between mt-6">
                            ...
                            <button
                                ...
                                className={`py-2 px-4 rounded-md text-white ${
                                    guardianDetails ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-gray-400 cursor-not-allowed'
                                }`}
                ...
                {step === 3 && (
                    <>
                        <div className="mb-4">
                            <label className="block text-gray-700 font-semibold">Previous Schooling Details</label>
