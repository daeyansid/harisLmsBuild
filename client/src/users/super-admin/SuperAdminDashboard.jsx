...
const SuperAdminDashboard = () => {
    ...
    useEffect(() => {
        const hasReloaded = sessionStorage.getItem('hasReloadedSuperAdmin');
        if (!hasReloaded) {
            sessionStorage.setItem('hasReloadedSuperAdmin', 'true');
    ...
    return (
        <div className="container mx-auto px-4">
            <div className="mb-4">
                <p className="text-custom-blue text-lg md:text-xl">Welcome Back Super Admin, <b>{userInfo.username}</b></p>
                <p className="text-gray-500 text-sm md:text-base">Track your Analytics and Manage your School Branch</p>
            </div>
